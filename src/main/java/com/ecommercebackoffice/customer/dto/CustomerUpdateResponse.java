...
public class CustomerUpdateResponse {
    ...
    private final String phonNumeber;
    private final LocalDateTime createdAt;
    private final LocalDateTime updatedAt;
    private final CustomerStatus customerStatus;

    private CustomerUpdateResponse(Long id, String name, String email, String phonNumeber, LocalDateTime createdAt, LocalDateTime updatedAt, CustomerStatus customerStatus) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.phonNumeber = phonNumeber;
