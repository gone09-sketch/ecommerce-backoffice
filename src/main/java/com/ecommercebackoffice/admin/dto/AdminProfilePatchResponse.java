...
public class AdminProfilePatchResponse {
    // 속성
    ...
    // 생성자
    public AdminProfilePatchResponse(Long id, String name, String email, String phoneNumber, String role, String status,
    ...
    // 기능
    public static AdminProfilePatchResponse from(Admin admin) {
        return new AdminProfilePatchResponse(
                admin.getId(),
                admin.getName(),
                admin.getEmail(),
