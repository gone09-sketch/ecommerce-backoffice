...
public class AdminRejectCreateResponse {
    // 속성
    ...
    // 생성자
    public AdminRejectCreateResponse(Long id, String name, String email, String phoneNumber, String role, String status,
    ...
    // 기능
    public static AdminRejectCreateResponse from(Admin admin) {
        return new AdminRejectCreateResponse(
                admin.getId(),
                admin.getName(),
                admin.getEmail(),
