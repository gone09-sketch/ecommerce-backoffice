...
public class AdminPageListResponse {
    ...
    // 생성자
    public AdminPageListResponse(Long id, String name, String email, String phoneNumber, String role, String status,
    ...
    // 기능
    public static AdminPageListResponse from(Admin admin) {
        return new AdminPageListResponse(
                admin.getId(),
                admin.getName(),
                admin.getEmail(),
