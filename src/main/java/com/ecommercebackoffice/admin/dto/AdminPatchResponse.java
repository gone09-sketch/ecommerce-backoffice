...
public class AdminPatchResponse {
    ...
    // 생성자
    public AdminPatchResponse(Long id, String name, String email, String phoneNumber, String role, String status,
    ...
    // 기능
    public static AdminPatchResponse from(Admin admin) {
        return new AdminPatchResponse(
                admin.getId(),
                admin.getName(),
                admin.getEmail(),
