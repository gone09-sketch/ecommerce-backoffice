...
public class AdminRolePatchResponse {
    ...
    // 생성자
    public AdminRolePatchResponse(Long id, String name, String email, String phoneNumber, String role, String status,
    ...
    // 기능
    public static AdminRolePatchResponse from(Admin admin) {
        return new AdminRolePatchResponse(
                admin.getId(),
                admin.getName(),
                admin.getEmail(),
